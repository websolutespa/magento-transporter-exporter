...
namespace Websolute\TransporterExporter\Model;
...
class Config
{
    const EXPORT_IS_ENABLED_CONFIG_PATH = 'transporter_exporter/general/enabled';
    ...
    public function isEnabled(): bool
    {
        return $this->baseConfig->isEnabled() && (bool)$this->scopeConfig->getValue(
            self::EXPORT_IS_ENABLED_CONFIG_PATH,
